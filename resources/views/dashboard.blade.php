<x-layouts::app.full-width title="Gestión de Pacientes">
    <div class="py-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Gestión Global de Pacientes</h1>
                <p class="text-sm text-slate-500">Base de datos clínica y administración de perfiles.</p>
            </div>
