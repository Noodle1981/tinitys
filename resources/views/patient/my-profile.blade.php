        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-slate-200">
                    ...
                    <a href="{{ route('stage-1', $patientId) }}" class="inline-block px-4 py-2 bg-slate-100 text-slate-700 rounded-md text-sm font-semibold">Refinar Perfil</a>
                </div>
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-slate-200">
                    ...
                    <a href="{{ route('stage-2', $patientId) }}" class="inline-block px-4 py-2 bg-slate-100 text-slate-700 rounded-md text-sm font-semibold">Refinar Capas</a>
                </div>
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-slate-200">
                    ...
                    <a href="{{ route('stage-3', $patientId) }}" class="inline-block px-4 py-2 bg-slate-100 text-slate-700 rounded-md text-sm font-semibold">Refinar Umbral</a>
                </div>
            </div>
