<script>
(function() {
    const registerTinnitusModules = () => {
        if (!window.Alpine) return;

        // --- MAPPER COMPONENT ---
        if (!Alpine.data_registry['tinnitusMapper']) {
        ...
        if (!Alpine.data_registry['tinnitusCalibrator']) {
    ...
    if (window.Alpine) registerTinnitusModules();
    else document.addEventListener('alpine:init', registerTinnitusModules);
})();
</script>
